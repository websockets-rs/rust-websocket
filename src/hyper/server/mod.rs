...
use ::hyper::header::{Headers, Expect, Connection};
use ::hyper::http;
use ::hyper::method::Method;
use ::hyper::net::{NetworkListener, NetworkStream, HttpListener, HttpsListener, SslServer};
use ::hyper::status::StatusCode;
...
fn handle<H, L>(mut server: Server<L>, handler: H, threads: usize) -> ::hyper::Result<Listening>
