...
impl<T: Write + Read> Write for BufReader<T> {
	#[inline]
...
#[cfg(feature="async")]
impl<T: AsyncRead> AsyncRead for BufReader<T> {
	#[inline]
...
#[cfg(feature="async")]
impl<T: AsyncWrite + Read> AsyncWrite for BufReader<T> {
	#[inline]
